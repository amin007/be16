...
class Masukdatabanyak_Tanya extends \Aplikasi\Kitab\Tanya
{
#==========================================================================================
...
#==========================================================================================
	public function tarikNombor($jadual = 'be16_kawal', $medan = '*')
	{
		# define('NOMBORID', serialize (array()) );
		$IDNum = unserialize(NOMBORID);
		$dataID2 = array();

		//$IDNum = sprintf("%012d", $IDNum);
		foreach ($IDNum as $id):
			$id2 = str_pad($id, 12, '0', STR_PAD_LEFT); 
			//echo $id2 . '<br>';
			$dataID2[] = $id2;
		endforeach;
	
		$dataID = "'" . implode("','",$dataID2) . "'";
		//echo '$dataID:' . $dataID;
